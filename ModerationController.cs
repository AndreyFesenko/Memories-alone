...
namespace ModerationService.Controllers
{
    ...
    public class ModerationController : ControllerBase
    {
        ...
        /// <summary>Create moderation review (submit content to moderation)</summary>
        [HttpPost]
        ...
        /// <summary>List reviews (filter by status optional)</summary>
        [HttpGet]
        ...
        /// <summary>Make decision on review</summary>
